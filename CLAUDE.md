...
Corporate website for CodeCrew Software Inc. (codecrew.ca). Astro 5 static site with Vue 3 island components, Tailwind CSS 4, and GSAP animations. Deployed to GitHub Pages via GitHub Actions on push to `main`.
...
- Custom domain: codecrew.ca (configured via `public/CNAME` and `astro.config.mjs` site field)
